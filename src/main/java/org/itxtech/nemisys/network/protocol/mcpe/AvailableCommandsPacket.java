...
public class AvailableCommandsPacket extends DataPacket {
    ...
    public void decode() {
        ...
        while (len-- > 0) {
            ...
            //MainLogger.getLogger().info("cmd: "+name);
        ...
        commands.forEach((name, cmdData) -> {
            ...
            for (CommandOverload overload : data.overloads.values()) {
                ...
                for (CommandParameter parameter : overload.input.parameters) {
                    ...
                    //MainLogger.getLogger().info("\tparam: "+parameter.name);

                    int type;
                    if (parameter.enumData != null) {
                        //MainLogger.getLogger().info("\t\tenum: "+ parameter.enumData.getName()+String.join(", ", parameter.enumData.getValues()));
